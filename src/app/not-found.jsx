...
export default function NotFound() {
    return(
        <div className='fixed z-[9999] top-0 left-0 w-full h-screen overflow-y-auto  bg-black'>
            <div className="relative h-screen overflow-y-hidden">
                ...
                <div className="flex flex-col items-center gap-4 md:gap-6 lg:gap-7 absolute z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
